...
import net.superadmin.utility.OpenBrowser;
...
public class EI_SuperAdmin_StepDef {
	...
	@Then("user is to click the Warning and Safety content")
	public void user_is_to_click_the_warning_and_safety_content()
	{
		eisuperadminpage.clickWarningAndSafetyContent();
	}
