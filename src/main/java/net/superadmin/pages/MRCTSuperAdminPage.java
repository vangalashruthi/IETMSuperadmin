...
public class MRCTSuperAdminPage {

	WebDriver driver;
	
	public MRCTSuperAdminPage(WebDriver driver)
	{
	...
	@FindBy(how = How.XPATH ,using= "//a[text()=' MANAGE RELATED CONTENT TYPES']")
	WebElement manageRelatedContentType;
	
	@FindBy(how = How.XPATH ,using= "//input[@type='search']")
	WebElement searchTextBox;
	
	@FindBy(how = How.XPATH ,using= "(//th[@class='sorting sorting_asc'])[1]")
	...
	@FindBy(how = How.XPATH ,using= "//button[@title='Add Item']")
	WebElement addItemButton;
	
	@FindBy(how = How.NAME ,using= "name")
	WebElement contentTypeNameTextbox;
	
	@FindBy(how = How.ID ,using= "adUser")
	WebElement saveButton;
	
	@FindBy(how = How.XPATH ,using= "(//button[@class='close'])[3]")
	WebElement closeAddContentType;
	...
	public void clickManageRelatedContentType()
	{
		manageRelatedContentType.click();
	}
	...
	public void verifyontentTypeTextbox()
	{
		contentTypeNameTextbox.click();
		contentTypeNameTextbox.sendKeys("test");
	}
	public void verifySaveButton()
	{
		saveButton.isDisplayed();
	}
	public void clickCloseAddContentType()
	{
		closeAddContentType.click();
	}
